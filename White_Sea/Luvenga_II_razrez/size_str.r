...
(mean.sizestr.sqmeter<-tapply(size.str.sqmeter$Freq,INDEX=list(size.str.sqmeter$year, size.str.sqmeter$tidal_level, size.str.sqmeter$Length.int),FUN=mean, na.rm=T))
mean.sqmeter.df<-as.data.frame(mean.sizestr.sqmeter)
(sd.sizestr.sqmeter<-tapply(size.str.sqmeter$Freq,INDEX=list(size.str.sqmeter$year, size.str.sqmeter$tidal_level,  size.str.sqmeter$Length.int),FUN=sd, na.rm=T))
...
(sem.sizestr.sqmeter <-t(sd.sizestr.sqmeter/sqrt(n.samples)))
