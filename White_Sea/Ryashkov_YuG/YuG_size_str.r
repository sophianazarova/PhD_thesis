...
plot(y=N2.mean.sqmeter, x=names(N2.mean.sqmeter),pch=15, main="Южная губа о. Ряшкова",
     ...
     ylim=c(0, max(N2.mean.sqmeter)+max(N2.sem.sqmeter)),
     xlab="год", ylab="N, экз./кв.м")
...
plot(x=names(Length.max), y=Length.max, type="none", main="Южная губа о. Ряшкова", xlab="год", ylab="L max, мм")
...
plot(y=B.mean.sqmeter, x=names(B.mean.sqmeter),pch=15, main="Южная губа о. Ряшков", 
...
plot(y=B.mean.sqmeter, x=names(B.mean.sqmeter),pch=15, main="Южная губа о. Ряшков", type="n",
...
write.table(t(young.old.percents), file="YuG_young_old_percent.csv", sep=";", dec=",")
...
plot(y=young.old.percents[1,], x=colnames(young.old.percents),pch=15, type="n", main="Южная губа о. Ряшков", 
...
write.table(B8.mean.sqmeter, file="YuG_biomass_old.csv", sep=";", dec=",")
