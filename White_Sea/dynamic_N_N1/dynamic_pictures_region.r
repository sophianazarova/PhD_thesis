...
# северный архипелаг
pdf(file="N2_dynamic_North_big.pdf", family="NimbusSan") # указываем шрифт подпией
...
dev.off()
embedFonts("N2_dynamic_North_big.pdf") #встройка шрифтов в файл

# картинка про Лувеньгу
pdf(file="N2_dynamic_Luvenga_big.pdf", family="NimbusSan") # указываем шрифт подпией
...
dev.off()
embedFonts("N2_dynamic_Luvenga_big.pdf") #встройка шрифтов в файл
