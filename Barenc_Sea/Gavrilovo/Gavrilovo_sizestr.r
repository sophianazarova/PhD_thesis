setwd("~/Dropbox/PhD_thesis/PhD_thesis/Barenc_Sea/Gavrilovo/")
...
#>1mm
(sum.sizestr2.sqmeter.percents.middle <- t(t(sum.sizestr.sqmeter.middle[2:nrow(sum.sizestr.sqmeter.middle),]) / colSums(sum.sizestr.sqmeter.middle)*100))
