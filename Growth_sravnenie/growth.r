...
pdf(file="Europe_growth_groups_big.pdf", family="NimbusSan")
plot(x=axe_X,y=axe_Y,type="n", xlab = "возраст, годы", ylab="L, мм", cex = 2, cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2)
points(Eclust1[1:6],pch=15, type = "b", cex=1.5, col = "red")
points(Eclust2[1:6],pch=16, type = "b", cex=1.5, col = "brown")
points(Eclust3[1:6],pch=17, type = "b", cex=1.5, col = "red")
points(Eclust4[1:6],pch=18, type = "b", cex=1.5, col = "red")
points(Eclust5[1:6],pch=19, type = "b", cex=1.5, col = "cyan")
points(Eclust6[1:6],pch=20, type = "b", cex=1.5, col = "green")
legend(x="topleft", legend = seq(1:6), pch=c(15,16,17,18,19,20), col = c("red", "brown", "red", "red", "cyan", "green"), bty = "n", title = "группы", cex = 1.5)
dev.off()
embedFonts("Europe_growth_groups_big.pdf")